...
{!select.length&&<p>Empty</p>}
      ...
      {/* <div style={path=="/Home"?{display:"none"}:{display:"flex"}} className="back">
       ...
       <li style={{transform:"translate(-10px,-5px)"}}>{back}</li> 
        ...
        <img src={logo} alt="" width={"50px"} height={"50px"} style={{borderRadius:"50%"}} />
        <li className="shoping_card nons" onClick={show}>    
       ...
       <nav>
        ...
        <ul>
          ...
          <li className="cas">Elcectronics</li>
                  ...
                  <li className="shoping_card cas" style={path==="/Company"?{display:"none"}:path==="/Shopping%20mall"?{display:"none"}:{display:"flex"}} onClick={show}>    
