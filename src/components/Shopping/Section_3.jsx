  ...
  return (
    ...
    <br />
         ...
         <div className="ds" style={all}>
          ...
          <p>Lorem ipsum, dolor sit uae eius fugit vero magnam illo earum perspiciatis architecto? Omnis?</p>
         </div>
        </div>
        </div>
        ...
        <div className="Company_features" style={all}>
          <div className="mx_company" style={all}>
           ...
           <h1>Long</h1>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officiis, dolore? Eaque voluptatibus totam iure. In fugiat ex velit! Temporibus facilis omnis ut odio beatae nemo a in, minus voluptatem iure?</p>
           </div>
            </div>
            <div className="lq">
